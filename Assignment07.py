## ------------------------------------------------------------------------ #
# Title: Assignment 07
# Description: Pickling anf structured error handling application
#              modified the script of assignment 06 to use picking instead of
#              text file; and to use error handling structure
...
# Tao Ye, 5.25.2020, Modified code to complete assignment 7
# ------------------------------------------------------------------------ #
import pickle

# Data -------------------------------------------------------------------- #
# Declare variables and constants
strFileName = "ToDoFile.dat"  # The name of the binary data file for pickling
